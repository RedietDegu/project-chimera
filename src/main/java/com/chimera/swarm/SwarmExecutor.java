 ...
 *
 * <p>Each dispatched task runs on its own Java 21 Virtual Thread. Because
 * virtual threads are lightweight and decoupled from OS threads, the swarm
 * can run thousands of Workers in parallel without exhausting the underlying
